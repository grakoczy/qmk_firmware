 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCTR | WIN  |LOWER | Enter| /Space  /       \Enter \  |SPACE |RAISE | RAlt | RCTR |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
  [_QWERTY] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  KC_CAPS,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,   KC_K,    KC_L,    KC_SCLN, LT(_NUMPAD,KC_QUOT),
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  KC_LSFT, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_MUTE,  KC_D_MUTE,KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 KC_LGUI, KC_LCTRL, KC_LOWER, KC_LALT,  KC_ENT   ,  KC_ENT,  KC_SPC,   KC_RAISE, KC_RALT, KC_RCTRL
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
...
[_LOWER] = LAYOUT(
  ...
  _______, KC_EXLM,   KC_AT, KC_BTN1,  KC_BTN3, KC_BTN2,                       KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE,
...
[_RAISE] = LAYOUT(
  ...
  _______,  KC_INS,  KC_PSCR,   KC_APP,  KC_SCRL, XXXXXXX,                        KC_PGUP, KC_PRVWD,   KC_UP, KC_NXTWD,KC_DLINE, KC_BSPC,
...
static void render_logo(void) {
    static const char PROGMEM hell_logo[] = {255,  1,  1,  1,241,241,241,241,241,241,241,241,113,113,113,113,113,113,113,113,113,113,113,241,241,241,241,241,  1,  1,  1,255,255,  0,  0,  0,255,255,255, 15,  3,  1,  0,224,240,248,252,252,124,124,124, 96, 64, 64, 64,127,127,255,255,255,  0,  0,  0,255,255,  0,  0,  0,255,255,255,240,192,128,  0,  7, 15, 31, 63, 63, 60, 60, 60, 60,  0,  0,  0,  0,252,255,255,255,  0,  0,  0,255,255,128,128,128,143,143,143,143,143,143,143,143,142,142,142,142,142,142,142,142,142,142,143,143,143,143,143,143,128,128,128,255};
